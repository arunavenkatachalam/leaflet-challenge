...
d3.json(url).then(function(earthquake_data){
    d3.json(url).then(function(tectonicplates_data){
...
function createFeatures(earthquake_data,tectonicplates_data) {
    ...
    function onEachFeature(feature, layer) {
      ...
      let tectonicplates = L.geoJSON(tectonicplates_data, {
            style: function() {
                return {
                    color: "blue",
                    weight: 2.5
       ...
       // Create Map
        createMap(earthquake,tectonicplates);
}
